    ...
    return (
        <header className={navbar ? 'header-active' : 'header'}>
            ...
            <div className="fixed right-0 bottom-0 p-12 z-50">
                <Link activeClass="active" className="hover:text-theme hover:fake-bold" to="home" spy={true} smooth={true} duration={500} offset={-50}>
                    <a className="px-1 py-1 border rounded-full bg-gray-500 text-white font-semibold mt-2 flex items-center space-x-3 hover:border hover:border-theme hover:text-text-primary group hover:bg-white">
