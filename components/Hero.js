...
function Hero() {
  return (
    <div className="block bg-[url('../assets/cover.jpg')] w-full h-64 md:h-[30rem] bg-cover md:bg-center md:px-14">
        <div className="container m-auto">
            <div className="flex flex-wrap md:flex-nowrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0">
                <div className="text-white pt-12 md:pt-36 mx-auto">
                    ...
                    <a href="/api/lana-kosogova" download><button className="px-8 py-3 border bg-theme text-white font-semibold mt-2 flex items-center space-x-3 hover:border hover:border-theme hover:text-text-primary group hover:bg-white">
