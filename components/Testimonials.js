		...
		<div className="container m-auto py-6 md:py-24 items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
			...
			<section className="w-full">
                ...
                <div className="flex flex-col">
                    <div className="w-3/4 mx-auto bg-white shadow-lg ring-1 ring-black/5 rounded-xl gap-6 dark:bg-slate-100 dark:highlight-white/5 p-6">
                        <div className="flex flex-row mx-10">
                            <div className=""> 
                                <Image src={c} alt="c" width="100" height="100" className="m-auto"/>
                            </div>
                            <div className="ml-10">
                        ...
                        <div className="flex flex-row mt-5">
                            <div className="">
                                <Image src={Lisa} alt="profilepic" width="70" height="70" className="rounded-full"/>
                            </div>
